...
Version.Text = "v1.0.0 | made by POOHHUB"
...
local function CLAL_fake_script() -- Settings.SettingsScript 
	...
	task.spawn(function()
		...
		script.Parent.Version.Text = string.format("%s | made by POOHHUB", shared.FakeInternal.Version)
	end)
end
...
local function POOHHUB() -- ScriptHub.ScriptHubScript 
	...
	local function GetScript(file)
		...
		local url = string.format("https://raw.githubusercontent.com/POOHHUB/KumphuchaHUB/main/Popular/%s.lua", file)
	...
	local scripts = {
		{
			Name = "Kamphucha Hub",
			Script = GetScript("KamphuchaHub"),
			Author = "By KamphuchaHub",
			Description = "The script On Blox Fruit Key.",
			Image = GetImage("KamphuchaHub", "https://cdn.discordapp.com/attachments/964017953764958258/1071777880574537830/4_20230205195746.png")
		},
		{
			Name = "Domain X",
			...
			Image = GetImage("DomainX", "https://cdn.discordapp.com/attachments/1025648612291641385/1160848602135011339/tkNvWlW.png?ex=65362782&is=6523b282&hm=573d22c1d65b002463c366fcd6231bf0193d31d875573001cfd29b7245f939af&")
		},
		{
			Name = "V.G Hub",
			...
			Image = GetImage("V.GHub", "https://cdn.discordapp.com/attachments/1025648612291641385/1160848505078816768/gPWKbhS.png?ex=6536276b&is=6523b26b&hm=e06abf449478739fdd766691d1e3a8c8e848929e3bb10d77ad8c7e950ec353d5&")
		},
		{
			Name = "Fates Admin",
			...
			Image = GetImage("FatesAdmin", "https://cdn.discordapp.com/attachments/1025648612291641385/1160848379128057917/uYJYkdN.png?ex=6536274d&is=6523b24d&hm=a5006a6a53411ecd3e837f9cc081964e16a9de597918a646aa82e99806860b3c&")
		},
		{
			Name = "Infinite Yield",
			...
			Image = GetImage("InfiniteYield", "https://cdn.discordapp.com/attachments/1025648612291641385/1160848258155941898/zsvlYCe.png?ex=65362730&is=6523b230&hm=343668fd388a260e654d547f1662c1d16d7d5b7b92e5014e6ec9dab99623fb3c&")
		},
		{
			Name = "Orca",
			...
			Image = GetImage("Orca", "https://cdn.discordapp.com/attachments/1025648612291641385/1160848155273859112/TQFjjYp.png?ex=65362717&is=6523b217&hm=1e21048a3b5189daaca43ce2022da9702e16e17daf89582cb2e9152c2d0322e4&")
		},
		{
			Name = "Hydroxide",
			...
			Image = GetImage("Hydroxide", "https://cdn.discordapp.com/attachments/1025648612291641385/1160848047543169094/6zjhfEh.png?ex=653626fe&is=6523b1fe&hm=3274babe06bf6b7feac519e40cabae25251d42fc86dbd344435de7860de6592d&")
		},
		{
			Name = "Secure Dex v3",
			...
			Image = GetImage("SecureDexV3", "https://cdn.discordapp.com/attachments/1025648612291641385/1160847915846205460/aJWoz5B.png?ex=653626de&is=6523b1de&hm=ac9707feacc28efc91b59c9c74f9d07c1364c2e1ce4b069dd9479696594b28a4&")
		},
		{
			Name = "Universal Esp",
			...
			Image = GetImage("UniversalEsp", "https://cdn.discordapp.com/attachments/1025648612291641385/1160847821742821417/X4vjIuQ.png?ex=653626c8&is=6523b1c8&hm=b8f9ab9e0051af5b9d40464be896627422bf35652a602426d4d7448f0c5deccf&")
		},
		{
			...
			Image = GetImage("UniversalAimbot", "https://cdn.discordapp.com/attachments/1025648612291641385/1160847604825993278/VFdn5p4.png?ex=65362694&is=6523b194&hm=f2775572fe8693d2b756d4674aa397e184316fae77b7b108795b77b13e4a4237&")
		},
		{
			Name = "Spotify Player",
			...
			Image = GetImage("SpotifyPlayer", "https://cdn.discordapp.com/attachments/1025648612291641385/1160847666817802320/bY3uRvq.png?ex=653626a3&is=6523b1a3&hm=2dd9bbb36cdac1d3f0377179757133faacff8db641aed2b165e76fdb54166a94&")
		}
	}
