...
local Window = Library.CreateLib("POOHHUB", "DarkTheme")

local Tab = Window:NewTab("script all map")
local Section = Tab:NewSection("POOHHUB")
...
local Tab = Window:NewTab("APS")
local Section = Tab:NewSection("POOHHUB")
Section:NewButton("APS", "APS", function()
...
local Section = Tab:NewSection("POOHHUB")
Section:NewButton("SWAG MODE", "SWAG MODE", function()
