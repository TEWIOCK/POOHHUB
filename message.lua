...
_G.Settings = {
	...
	Fruits = {
		...
		["Select Devil Fruits"] = {}, --{"Rocket-Rocket","Spin-Spin","Chop-Chop","Spring-Spring","Bomb-Bomb","Smoke-Smoke","Spike-Spike","Flame-Flame","Falcon-Falcon","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Quake-Quake","Buddha-Buddha","Love-Love","Spider-Spider","Sound-Sound","Phoenix-Phoenix","Portal-Portal","Rumble-Rumble","Pain-Pain","Blizzard-Blizzard","Gravity-Gravity","Mammoth-Mammoth","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Spirit-Spirit","Dragon-Dragon","Leopard-Leopard"}
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Gay Hub Premium Scripts") then
			makefolder("Gay Hub Premium Scripts")
		end
		if not isfolder("Gay Hub Premium Scripts/Blox Fruits/") then
			makefolder("Gay Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Gay Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Gay Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Gay Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Gay Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Gay Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
OrionLib:MakeNotification({
	Name = "Gay Hub",
	Content = "Gay Hub",
	Image = "rbxassetid://15171692873",
	Time = 5
})


local Window = OrionLib:MakeWindow({Name = "Orion Example", HidePremium = _G.Gay, SaveConfig = true, ConfigFolder = "GayHub"})

--Player Tab--

local main = Window:MakeTab({
	Name = "Main",
	Icon = "rbxassetid://15171688744",
	PremiumOnly = false
})

local buy = Window:MakeTab({
	Name = "Shop",
	Icon = "rbxassetid://15171685951",
	PremiumOnly = false
})

local Fs = Window:MakeTab({
	Name = "FightingStyle",
	Icon = "rbxassetid://15172010780",
	PremiumOnly = false
})

local Mf = Window:MakeTab({
	Name = "Mastery Functions",
	Icon = "rbxassetid://15172061578",
	PremiumOnly = false
})

local Sp = Window:MakeTab({
	Name = "Stats Page",
	Icon = "rbxassetid://15172108756",
	PremiumOnly = false
})

local Tp = Window:MakeTab({
	Name = "Teleports",
	Icon = "rbxassetid://15172182026",
	PremiumOnly = false
})

local BF = Window:MakeTab({
	Name = "Devil Fruits",
	Icon = "rbxassetid://15172378788",
	PremiumOnly = false
})
...
local Cb = Window:MakeTab({
	Name = "Combat",
	Icon = "rbxassetid://15172403748",
	PremiumOnly = false
})
local M = Window:MakeTab({
	Name = "Misc",
	Icon = "rbxassetid://15172451340",
	PremiumOnly = false
})
...
local cf = Window:MakeTab({
	Name = "Setting",
	Icon = "rbxassetid://15171958150",
	PremiumOnly = false
})

local admin = Window:MakeTab({
	Name = "Gay",
	Icon = "rbxassetid://15171692873",
	PremiumOnly = true
})
...
if World1 then
	...
	main:AddLabel("Status : God Human (List)")
	
	main:AddLabel("Status : Farm Materail")
	...
	main:AddToggle({Name = "Auto Farm Material",Default = AutoFarmMaterial,callback = function(x)
		AutoFarmMaterial = x
		if x == false then
			wait()
			toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
elseif World3 then
	...
	main:AddLabel("Cursed Dual Katana")
	
	main:AddLabel("Tushita Quest")
	...
	if Tushita_Quest1 == false then
		...
		main:AddLabel("Use Auto Buddy Sword / Self-ignite torch / Mob Aura")
		main:AddLabel("Yama Quest")
		...
		main:AddLabel("Walk up to the Halloween boss and kill afterward, light your torch and turn on the Auto Mob Aura.")
...
local SwordMulti = Ms:AddDropdown({
	Name = "Select Sword",
	Options  = AllSwordInInventroy,
...
Mf.AddButton({Name = "Refresh",callback = function()
	SwordMulti.Clear();
	local AllSwordInInventroy = {};
	for i, v in pairs(game:GetService("ReplicatedStorage").Remotes['CommF_']:InvokeServer("getInventoryWeapons")) do
		if (type(v) == "table") then
...
Mf:AddToggle({Name = "Auto Farm Sword Mastery",Default = _G.Settings.Mastery["Farm Mastery SwordList"],callback = function(x)
...
Sp:AddDropdown({
	Name = "Select Stats",
	Options  = {"Max Stats","Melee","Defense","Sword","Gun","Devil Fruits"},
	callback = function(value)
...
BF:AddLabel("Devil Fruits")

BF:AddToggle({
	Name = "Auto Buy Random Fruits",
...
BF:AddLabel("Devil Fruits Sniper's")

SelectDevilFruits = {"Rocket-Rocket","Spin-Spin","Chop-Chop","Spring-Spring","Bomb-Bomb","Smoke-Smoke","Spike-Spike","Flame-Flame","Falcon-Falcon","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Quake-Quake","Buddha-Buddha","Love-Love","Spider-Spider","Sound-Sound","Phoenix-Phoenix","Portal-Portal","Rumble-Rumble","Pain-Pain","Blizzard-Blizzard","Gravity-Gravity","Mammoth-Mammoth","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Spirit-Spirit","Dragon-Dragon","Leopard-Leopard"}
...
local PlayerDrop = Cb:AddDropdown({
	Name = "Select Player",
	Item = getplayers,
	callback = function(value)
		SelectPlayer = value
...
M:AddSlider({Name = "Select FPS Lock",Min = 5,Max = 240,Default = _G.Settings.HUD["FPS"],callback = function(x)
	_G.Settings.HUD["FPS"] = x
	SaveSettings()
end,})

M:AddToggle({Name = "Lock Set FPS",Default = _G.Settings.HUD["LockFPS"],callback = function(x)
...
buy:AddToggle({
	Name = "Auto Buy Color Enhancement",
	Default = _G.Settings.Main["Auto Buy Enchanment Haki"],
	callback = function(value)
		_G.Settings.Main["Auto Buy Enchanment Haki"] = value
		SaveSettings()
...
buy:AddLabel("Fragment")


buy:AddButton({Name = "Refund Stat", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end})

buy:AddButton({Name = "Reroll Race", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end})


buy:AddLabel("Buy Abilities")

buy:AddButton({Name = "Haki", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
end})
buy:AddButton({Name = "Geppo", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
end})
buy:AddButton({Name = "Soru", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
end})
buy:AddButton({Name = "KenHaki", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
end})

buy:AddLabel("Auto Buy Fighting Style")


buy:AddButton({Name = "Black Leg", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
end})

buy:AddButton({Name = "Electro", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
end})

buy:AddButton({Name = "Fishman Karate", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
end})

buy:AddButton({Name = "Dragon Claw", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
end})

buy:AddButton({Name = "Superhuman", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
end})
buy:AddButton({Name = "Death Step", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
end})
buy:AddButton({Name = "Sharkman Karate", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
end})
buy:AddButton({Name = "Electric Claw", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
end})

buy:AddButton({Name = "Dragon Talon", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
end})

buy:AddButton({Name = "Godhuman", callback = function()
...
buy:AddButton({Name = "Katana", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
end})

buy:AddButton({Name = "Cutlass", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
end})

buy:AddButton({Name = "Duel Katana", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
end})

buy:AddButton({Name = "Iron Mace", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
end})

buy:AddButton({Name = "Pipe", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
end})

buy:AddButton({Name = "Triple Katana", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
end})

buy:AddButton({Name = "Dual-Headed Blade", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
end})

buy:AddButton({Name = "Bisento", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
end})

buy:AddButton({Name = "Soul Cane", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
end})

buy:AddLabel("Gun")

buy:AddButton({Name = "Slingshot", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
end})

buy:AddButton({Name = "Musket",callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
end})

buy:AddButton({Name = "Flintlock", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
end})

buy:AddButton({Name = "Refined Flintlock", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
end})

buy:AddButton({Name = "Cannon", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
end})

buy:AddButton({Name = "Kabucha", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","2")
end})

buy:AddLabel({Name = "Accessory"})

buy:AddButton({Name = "Black Cape", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Black Cape")
end})

buy:AddButton({Name = "Toemo Ring", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Tomoe Ring")
end})

buy:AddButton({Name = "Swordsman Hat", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Swordsman Hat")
end})



cf:AddLabel("Webhook $ BaseSheet")
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		...
		["footer"] = {
			["text"] = "Made by tewiock".."\nTime".." : "..os.date("%c").." ("..os.date("%X")..")",
			["icon_url"] = "https://tr.rbxcdn.com/3b96118108a1d29fde7654b905169a3b/420/420/Decal/Png"
		},
	}}
	...
	if _G.SendWebHookPing then
		Message = {
			['username'] = "GayHub Webhook",
			["avatar_url"] = "https://tr.rbxcdn.com/3b96118108a1d29fde7654b905169a3b/420/420/Decal/Png",
			["content"] = "@everyone",
			["embeds"] = Embeds,
		}
	else
...
cf:AddTextBox({Name = "Webhook",Default = "Webhook Link",callback = function(x)
	Webhooklink = x
end})

cf:AddButton({Name = "Send Webhook",callback = function()
	WebHookLog:WebHookKaiTanSend(Webhooklink)
end})

Page_Settings.Line()

cf:AddTextBox({Name = "BaseSheet",Default = "Base Sheet Link",callback = function(x)
	Baselink = x
end})

cf:AddButton({Name = "Send BaseSheet",callback = function()
	WebHookLog:SheetBestLogSend(Baselink)
end})

Page_Settings.Line()
cf:AddButton({Name = "Hop Server", callback = function()
	ServerHop:Teleport()
end})
cf:AddButton({Name = "Rejoin", callback = function()
